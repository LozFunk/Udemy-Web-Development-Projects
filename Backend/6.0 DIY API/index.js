...
app.patch("jokes/:id", (req, res) =>{
  ...
  const replacementJoke = {
    ...
    jokeType: req.body.type || existingJokej.jokeType,
  };
...
app.delete("jokes/:id", (req,res) => {
  ...
  res.status(404).json({error: `Joke with the id: ${id} not found. No jokes were deleted`});
  }
});

//8. DELETE All jokes
app.delete("jokes/all", (req, rese)=>{
